...
figs_dir = '/afs/crc.nd.edu/user/c/coballe/molecular_mpns/figs/08022021'
...
for ep in range(epochs):
    ...
    if (ep+1) % 1 == 0:
        ...
        # ancestral sampling
        traj_xyz_ancestral = ancestral_sample(mod = mod , T = subset_size, dim_z = kwargs['zdim'],device = device, sample = False)
        ...
        for t in range(subset_size):
            z0, x0 = mod.mwg_sample(z0, x0, atomic_numbers = z, sample = False)
...
model_path = '/afs/crc.nd.edu/user/c/coballe/molecular_mpns/models/vae03.pt'        
